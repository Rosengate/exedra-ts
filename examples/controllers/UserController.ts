...
import { Controller, Path, Get, Post, Put, Delete, Name, Tag, Validation, Transformer } from '../../src';
...
class UserController extends Controller {
  ...
  storeUser() {
    return { id: 4, name: 'New User', email: 'new@example.com' };
  }

  @Put('/:id')
  @Name('users.update')
  updateUser() {
    return { id: 1, name: 'Alice Updated', email: 'alice@example.com' };
  }
